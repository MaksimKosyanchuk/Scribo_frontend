...
const Input = ({ className, onChange, onFocus, error, type, value, input_label, placeholder, required=false, confirmed=false, is_multiline = false, multiline_rows = 1, length = 120 }) => {
      ...
      <div className={"input"}>
        ...
        <div className="input_wrapper">
          ...
          <InputComponent
            ...
            readOnly={confirmed}
          />
          {confirmed ? <ConfirmedIcon className="inpuut_confirmed_icon app-transition"/> : <></> }
        </div>
      </div>
      {
